...
atmosphere = NCell(S_i, S_di, D_i, N_i, target_alts, alt_edges, lam, drag_lifetime_loc, need_update, chi_max=1.5, up_time=up_time)

atmosphere.run_sim_precor(T, upper=False)
atmosphere.save('./', "test_save_NLiveFlow", gap=0.05, force=True)
