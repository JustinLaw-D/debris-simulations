...
def update_lifetime(_a, _b):
    return False
atmosphere = NCell(S_i, S_di, D_i, [N_i1, N_i2], target_alts, [alt1, alt2], [dh, dh], lam, drag_lifetime, update_lifetime, up_time=up_time)

atmosphere.run_sim_precor(T, upper=False)
atmosphere.save('./', 'test_save_2CellNTypeLive', gap=0.01, compress=True)
