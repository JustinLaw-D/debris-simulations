...
def update_lifetime(_a, _b):
    return False
atmosphere = NCell(S_i, S_di, D_i, [N_i1, N_i2], target_alts, [alt1, alt2], [dh, dh], lam, drag_lifetime, update_lifetime, R_i=R_i)

atmosphere.run_sim_precor(T, upper=False)
atmosphere.save('./', 'test_save_2CellNTypeRocket', gap=0.01, compress=True)
